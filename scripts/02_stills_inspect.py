...
def inspect_prompt(shot_id):
    ...
    # שליפת הבריף כדי שג'ימיני ידע מה הפעולה המקורית
    ...
    # סיסטם פרומפט משולב (צניעות + וידאו)
    sys_prompt = f"""
    ...
    try:
        ...
        shot["stills"]["inspector_feedback"] = "Checked by Gemini (Modesty + T=0 Logic)"
